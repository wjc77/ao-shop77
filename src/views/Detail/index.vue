<script setup>
// 注意：大括号是解构，根据需要解构对象，引入组件不需要解构，直接整个引入
// 按需导出export(需要加{}) 默认导出export default(不需要加{})
    ...
    <div class="container" v-if="goods.details">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <!--  使用${goods.categories[1].id}` }">{{ goods.categories[1].name数据渲染不出来 因为goods一开始为{}空对象
                属于渲染模板时遇到对象的多层属性访问可能出现的问题
      ...
      <div class="info-container">
        <div>
          <div class="goods-info">
            <div class="media">
              <!-- 图片预览区 -->
              <WaoImageView :image-list="goods.mainPictures" />
              <!-- 统计数量 -->
            ...
            <div class="spec">
              ...
              <!-- sku组件 -->
              <WaoSku :goods="goods" @change="skuChange" />
              <!-- 数据组件 -->
