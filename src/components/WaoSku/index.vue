<!-- 引入的第三方组件 熟悉流程 -->
<!-- 先看props和emit，props决定了当前组件接收什么数据，emit决定了会产出什么数据 即入参出参-->
<!-- 验证组件是否成功使用：1.传入必要数据是否交互功能正常 2.点击选择规格，是否正常产出数据-->
<!-- SKU组件的作用：产出当前用户选择的商品规格，为加入购物车操作提供数据信息 例如详情页的表示颜色、尺码的 -->
<!-- SKU：存货单位，也叫库存单元，是一个会计学名词，定义为库存管理中的最小可用单元 -->
<template>
  <div class="goods-sku">
